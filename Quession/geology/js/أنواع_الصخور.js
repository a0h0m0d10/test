(function() {
  ...
  let questions = [
    {
      question: "   العمليات التى تؤدى مباشرة إلى تكوين الصخور النارية",
      answers: ["النحت والترسيب", "التماسك والتلاحم", "الضغط والحرارة", "الانصهار والتجميد"],
      correctAnswer: 4
    },
    {
      question: "    فى دورة الصخور يتحول الجرانيت والبازلت إلى فتات صخرى عن طريق",
      answers: [" الترسيب", " التبريد", " التعرية", " الحركات الأرضية الهابطة"],
      correctAnswer: 3
    },
    {
      question: "   إذا رجعت بالزمن إلى الماضى عند بداية تكوين كوكب الأرض ، نجد أن معظم سطح الأرض مغطى بـ",
      answers: ["الماء ", "المواد المنصهرة", "الصخور الصلبة", " الجليد"],
      correctAnswer: 2
    },
    {
      question: "    الصخور المكونة لقشرة الأرض الخارجية عند بداية تكوين الأرض غالباً تكونت نتيجة",
    ...
    },
    {
      ...
      answers: ["تحجر", " تحول", " نقل", " ترسيب"],
      correctAnswer: 2
    },
    {
      question: "    الصخر الكتلى الذى يحتوى على أمونيتات غير واضحة المعالم مما يلى على الأرجح هو",
      answers: [" الحجر الجيري", " الحجر الرملى", " الرخام", " الميكروجرانيت"],
      correctAnswer: 3
    },
    {
      question: "    العامل الذى يقدم دليلاً على أن الصخور النارية كانت منصهرة فى السابق هو وجود",
      answers: ["نسيج متبلور", " حفريات", " فحم", " كالسيت"],
      correctAnswer: 1
    },
    {
      question: "لا تحتوى الصخور النارية على حفريات لأنها",
      answers: ["صخور غير مسامية", "تتكون نتيجة تبلور الصهير", "أول صخور تكونت فى القشرة الأرضية", " المعادن المكونة لها شديدة الصلابة"],
      correctAnswer: 2
    },

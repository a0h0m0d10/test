  ...
  let questions = [
    {
      ...
      answers: [" البريق", "المخدش ", " المكسر", " الصلادة"],
      correctAnswer: 1
    },
    {
    ...
    },
    {
      ...
      answers: ["زنك ", " كبريتيد زنك", " حديد", "كبريتيد حديد "],
      correctAnswer: 2
    },
    {
      question: "   تتميز الأحجار الكريمة بخاصية",
      answers: [" التبلر", " الإنفصام ", "المخدش ", "عرض الألوان "],
      correctAnswer: 4
    },
    {
      question: "   المركب الذى يعد السبب الأساسى في إكتساب الأميثيست اللون البنفسجي يتكون من عنصرين هما",
      answers: ["الأكسجين، الحديد", " المنجنيز، الحديد", " الزنك، الحديد", " الحديد، الكربون"],
      correctAnswer: 1
    },
    {
      question: "   يتغير لون البلور الصخري إلي اللون الوردي بسبب",
      answers: [" كسر بعض الروابط بين ذرات عناصره", "  وجود فقاعات غازية كثيرة", "وجود شوائب من المنجنيز", " وجود شوائب من أكاسيد الحديد"],
      correctAnswer: 3
    },
    {
      question: "أحد معادن الكبريتات له لون أصفر شفاف فى الحالة النقية هو المعدن",
      answers: [" البريت", "  الجالينا", " السفاليرايت", "الكبريت "],
      correctAnswer: 3
    },
    {
      question: "   معظم الأسطح اللامعه الصلبة الملساء",
      answers: ["تشتت الضوء", " تمرر الضوء", "تعكس الضوء", "تمتص الضوء "],
      correctAnswer: 3
    },
    {
      question: "   المعدن الذي يتم التنقيب عنه كمصدر لعنصر الزنك",

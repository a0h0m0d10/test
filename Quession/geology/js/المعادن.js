(function() {
  ...
  let questions = [
    ...
    {
      question: "يمثل عنصر النيتروجين فى صخور القشرة الأرضية حوالى",
      answers: ["٧٨٪", " ١,٥٪", " أقل من ١,٥٪", " أكبر من ٧٨٪"],
      correctAnswer: 3
    },
    {
      question: "الاكسجين أكثر العناصر شيوعاً من حيث النسبة المئوية لتواجده فى",
      answers: [" اللب الداخلى", " الغلاف الجوى", "الوشاح ", "القشرة الأرضية"],
      correctAnswer: 4
    },
    {
      question: "يستخدم معدن المرو فى صناعة",
      answers: ["الأسمنت ", " القلم الرصاص", " الخزف", "الأكواب الزجاجية "],
      correctAnswer: 4
    },
    {
      question: "أي أنواع الصخور التالية يتكون من معدن يستخدم فى انتاج الأسمنت",

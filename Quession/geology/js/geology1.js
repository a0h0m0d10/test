(function() {
  ...
  let questions = [
    {
      question: " العلم الأساسى الذي يهتم بالبحث عن خامات الذهب والحديد هو علم",
      answers: ["الچيوكيمياء", "الطبقات", "الجيوفيزياء", "الچيولوچيا الطبيعية"],
      correctAnswer: 2
    },
    {
      question: "فرع الچيولوچيا الذى نعتمد عليه أساساً عند بناء ناطحة سحاب هو",
      answers: ["الچيوكيمياء", "لچيولوچيا الطبيعية", " الچيوفيزياء", "الچيولوچيا الهندسية"],
      correctAnswer: 4
    },
    {
      question: "يمكن تحديد عمر الصخور الرسوبية من خلال دراسة علم",
      answers: ["المعادن", "الترسيب", "الحفريات", "الجيوفيزياء"],
      correctAnswer: 3
    },
    {
      question: "العلم الذى يدرس الصخور التي تنضج فيها المواد العضوية اللازمة لتوليد الطاقة هو علم",
      answers: ["الجيولوجيا الهندسية", "الچيوفيزياء", "الچيوكيمياء", "چيولوچيا البترول"],
      correctAnswer: 4
    },
    {
      question: "  فرع الچيولوچيا الذى نعتمد عليه أساساً في الإستدلال علي طبيعة البيئة الساحلي للشعاب المرجانية",
      answers: ["المعادن", "الأحافير", "الچيوكيماء", "الچيوفيزياء"],
      correctAnswer: 2
    },
    {
      question: "يستدل علي أن نسبة عناصر مجموعة السيليكات تمثل ٩٨,٥٪ من وزن القشرة الأرضية من دراسة",
      answers: ["الچيولوچيا الطبيعية", "الچيولوچيا التركيبية", "الچيوفيزياء", "الچيوكيماء"],
      correctAnswer: 4
    },
    {
      question: "العلم الذى يدرس الخواص الفيزيائية والكيميائية للهيماتيت هو علم.",
      answers: ["الجيولوجيا الطبيعية", " المعادن والبلورات", " الجيولوجيا الهندسية", "الجيولوجيا التركيبية"],
      correctAnswer: 2
      
    },
    {
        question: "العلم الذي يدرس تأثير كل من البحيرات والحركات الأرضية والأنهار علي الصخور هو علم",
        answers: [" الطبقات", " الچيوكيمياء ", "  المياه الجوفية", " الجيولوجيا الطبيعية"],
        correctAnswer: 4

(function() {
  ...
  let questions = [
    {
      question: "جميع التراكيب التالية أولية ما عدا",
      answers: ["عبامات النيم", "التدرج الطبقي", "التطبق المتقاطع", "الشقوق الصخرية"],
      correctAnswer: 4
    },
    {
      question: "اعد الإلتواءات الصخرية أحد التراكيب",
      answers: ["الثانوية", "الأولية", "المتكونة بفعل الجفاف", "المتكونة بفعل العوامل البيئية"],
      correctAnswer: 1
    },
    {
      question: "عند تعرض الصخور الرسوبية لعوامل خارجية قد يتكون",
      answers: ["طية محدبة", "فالق عادي", "فاصل عمودي", "تطبق متقاطع"],
      correctAnswer: 4
    },
    {
      question: "أي مما يلي لا يؤدي إلى تكوين تراكيب چيولوچية؟",
      answers: ["القوي التكتونية", "العوامل البيئية", "الظروف المناخية", "دوران الأرض "],
      correctAnswer: 4
    },
    {
      question: "تتكون التشققات الطينية بسبب",
      answers: ["قوى ضغط", "قوى شد", "عوامل خارجية", "قوى ضغط وشد معاً"],
      correctAnswer: 3
    },
    {
      question: "التطبق المتقاطع تركيب چيولوچي قد ينتج عن",
      answers: ["الزلازل", "تيارات مائيه", "البراكين", "الضغط التكتوني"],
      correctAnswer: 2
    },
    {
      question: "علامات النيم تظهير غالباً في الصخور",
      answers: ["المتحولة", "الجرانيتية", "الرسوبية", "البازلتية"],
      correctAnswer: 3
    },
    
    {
      question: "طبقة رسوبية تتكون من حبيبات غير متساوية الحجم، الجزء العلوي منها حجم حبيباته ١ ميكرون والأوسط حجم حبيباته ١ مللي والسفلى حجم حبيباته ٣ مللي، فإن التركيب الجيولوجي الذى تمثله هذه الطبقة يعتبر",
      answers: ["تدرج طبقي", "تطبق متقاطع", "علامات النيم", "تشقق طيني "],
      correctAnswer: 1
    },

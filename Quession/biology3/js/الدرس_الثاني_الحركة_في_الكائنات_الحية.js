(function() {
  ...
  let questions = [
    {
      question: "حركة التدفق البروتوبلازمي داخل خلية كبدية ",
      answers: [" انتقالية", "كلية", "موضوعية", "دائبة"],
      correctAnswer: 4
    },
    {
      question: "ما مدى صحة العبارتين التاليتين ، في الخلايا الحية لنبات  البصل ترجع حركة السيتوبلازم لحركة البلاستيدات الخضراء ، بينما في الخلايا الحية لنبات الفول ترجع حركة البلاستيدات  لحركة السيتوبلازم",
      answers: [" العباراتان صحيحتان", "العبارتان خطأ", "العبارة الأولى صحيحة والعبارة الثانية خطأ", "العبارة الأولى خطأ والعبارة الثانية صحيحة"],
      correctAnswer: 4
    },
    {
      question: "ما الحركة التي يتميز بها السركوبلازم ",
      answers: [" دائبة موضعية  ", "موضعية وكلية ", " دائبة فقط", "موضعية فقط"],
      correctAnswer: 3
    },
    {
      question: "أي الحركات التالية  تعتمد في حدوثها على حركة الماء بين خلايا النبات",
      answers: ["النوم واليقظة ", "الشد بالمحاليق", "الانتحاء المائي", "الامتحاء الأرضي"],
      correctAnswer: 1
    },
    {
      question: "أي مما يلي يمثل الفائدة الرئيسية  من عملية الأنسياب السيتوبلازمي  داخل الخلية النباتية",
      answers: [" توصيل المغذيات إلى الأجزاء المختلفة من الخلية ", "المساعدة في إصلاح الخلية بعد تعرضها للتلف ", "السماح للنبات بالإستجابة للمثير الصوئي والنمو في أتجاهه", "حث الخلية النباتية على الأنقسام"],
      correctAnswer: 1
    },
    {
      question: "أثناء نمو نبات الفول رأسيا في التربة اصطدام جذرها بجسم صلب مما  أدى إلى توليد مجموعة من الإشارات لتحفيظ الجذر للنمو بعيدا عن ذلك الجسم أي مما يلي يمثل نوع هذه الحركة",
      answers: [" أنتحاء أرضي موجب", "حركة لمس ", "حركة شد", "أنتحاء مائي موجب"],
      correctAnswer: 2
    },
    {
      question: "كم يتراوح عدد الليفات العضلية الذي يوجد في خمس ألياف عضلية",
      answers: ["ألف : ألفين ", "ألفان: أربع آلاف", "خمسة آلاف  : عشرة آلاف", "ثلاثة آلاف : ستة آلاف"],
      correctAnswer: 3
    },
    {
      question: "أي مما يلي يعتبر الوحدة البنائية للعضلة الهيكلية",
      answers: [" الليفية العضلية ", "  الليفة العضلية", "القطعة العضلية", "الوحدة الحركية"],
      correctAnswer: 2
    },
    {
      question: "لييفة عضلية  تتكون من 5 مناطق شبهة مضيئة ( H ) ، 6 خطوط داكنة(Z)  ، 5 مناطق داكنة ( A ) فكم عدد القطع العضلية",
      answers: [" 7 ", " 6 ", " 5 ", " 4 "],
      correctAnswer: 3
    },

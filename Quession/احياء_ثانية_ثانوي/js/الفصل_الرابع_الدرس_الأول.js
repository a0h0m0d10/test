(function() {
  ...
  let questions = [
    {
      question: "كل مما يأتي من المواد الإخراجية ماعدا",
      answers: [" co2 ", " النيتروجين  ", "الماء", " اليوريا "],
      correctAnswer: 2
    },
    {
      question: "أي المواد الغذائية التالية ينتج عن تكسير نواتج هضمها حمض اليوريك ؟",
      answers: [" فول ", " أرز  ", "زبد", " عسل "],
      correctAnswer: 1
    },
    {
      question: "       من الفضلات التي تنتج عن تكسير المواد الكربوهيدراتية بعد هضمها",
      answers: [" o2 و co2", "  الماء و   o2      ", "الماء و co2      ", "  النيتروجين و CO2"],
      correctAnswer: 3
    },
    {
      question: "       أي مما يلى يعـتـبـر مـن نـواتـج التمثيل الغذائي الضارة الناتجة عن تكسير البروتينات في الإنسان ؟      ",
      answers: [" النيتروجين ", "  النشادر ", "حمض النيتريك", "  اليوريا"],
      correctAnswer: 4
    },
    
    {
      question: "      أي مما يلى لا يساهم في عملية الإخراج بالجسم ؟",
      answers: [" الغدة العرقية       ", " الشرج  ", "الحويصلة الهوائية", " خلايا الكبد "],
      correctAnswer: 2
    },
    {
      question: "       من وظائف طبقة بشرة جلد الإنسان      ",
      answers: [" تلطیف درجة حرارة الجسم", " استخلاص الفضلات النيتروجينية من الدم       ", "إنتاج العرق      ", " منع غزو البكتيريا للجسم      "],
      correctAnswer: 4
    },
    {
      question: "       أي التراكيب التالية تمتد خلال طبقتي الأدمة والبشرة في الجلد ؟      ",
      answers: [" الشعر والأوعية الدموية      ", "  الشعر والغدد العرقية      ", "الغدد العرقية والحلمات الحسية      ", " الغدد الدهنية والأوعية الدموية"],
      correctAnswer: 2
    },
    {
      question: "      الوظيفة الأساسية للعرق في الإنسان هي التخلص من       ",
      answers: [" حرارة الجسم الزائدة", "  الأملاح الزائدة بالجسم       ", "الماء الزائد بالجسم      ", " الفضلات النيتروجينية بالجسم "],
      correctAnswer: 1
    },
    {
      question: "      أي العبارات الآتية هي الأكثر دقة عن طبقتي بشرة الجلد ؟       ",
      answers: ["تعتمد الطبقة السطحية لبشرة الجلد على الطبقة الداخلية لها       ", " تعتمد الطبقة الداخلية لبشرة الجلد على الطبقة السطحية لها       ", "تعتمد كل من الطبقتين على الأخرى", " لا توجد علاقة بين الطبقتين      "],
      correctAnswer: 3
    },
    {
      question: "       يفقد الجلد لونه الطبيعي عند غياب الخلايا       ",
      answers: [" الموجودة في الطبقة السطحية لبشرة الجلد      ", "  الموجودة بقاعدة الطبقة الداخلية لبشرة الجلد      ", "المكونة للأنسجة الضامة بطبقة الأدمة للجلد      ", " المكونة للطبقة التي تلتصق بالجسم      "],
      correctAnswer: 2
    },
    {
      question: "جميع ما يلي يمكن حدوثه عند وضع اليد داخل كيس بلاستيك وربطه حول المعصم ماعدا       ",
      answers: [" ترتفع درجة الحرارة داخل الكيس ", " تنشط الغدد العرقية لاستخلاص العرق من الدم  ", "تنشط الغدد الدهنية في الجلد      ", " يظل العرق على سطح الجلد دون تبخر      "],
      correctAnswer: 3
    },
    {
      question: "       معدل إفراز العرق في فصل الشتاء",
      answers: [" يتوقف ", " يزداد  ", "يقل", " لا يتأثر      "],
      correctAnswer: 3
    },
    {
      question: "      تتصلب الشعرة وتتقصف عند غياب      ",
      answers: [" الغدة العرقية القريبة منها       ", " مادة الميلانين      ", "العضلة التي تحركها      ", " الغدة الدهنية المحيطة بها "],
      correctAnswer: 4
    },

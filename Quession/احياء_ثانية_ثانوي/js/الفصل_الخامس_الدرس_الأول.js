(function() {
  ...
  let questions = [
    {
      question: "الوظيفة الحيوية التي تعمل على تكيف الكائن الحي مع البيئة هي      ",
      answers: [" التنفس ", " الحركة  ", "النقل", " الإحساس "],
      correctAnswer: 4
    },
    {
      question: "أي العبارات التالية لا تنطبق على الأوكسينات ؟      ",
      answers: [" تتأثر بشكل كبير بالعوامل البيئية      ", "  لا تستطيع النفاذ خلال قطع الأجار      ", "استخدمها الإنسان لزيادة معدل نمو النبات      ", " مواد كيميائية تفرزها البراعم النباتية "],
      correctAnswer: 2
    },
    {
      question: "ي العبارات التالية غير صحيحة ؟",
      answers: [" الرطوبة تؤثر على الأوكسينات المتحكمة في نمو الجذر ", " الرطوبة لا تؤثر على الأوكسينات المتحكمة في نمو الساق      ", "الجاذبية تؤثر على الأوكسينات المتحكمة في نمو الساق      ", " الضوء لا يؤثر على الأوكسينات المتحكمة في نمو الساق "],
      correctAnswer: 4
    },
    {
      question: "التركيز العالي من الأوكسينات يسبب      ",
      answers: ["زيادة استطالة خلايا الجذر      ", "  زيادة استطالة خلايا الجذر والساق       ", "نقص استطالة خلايا الساق      ", "  نقص استطالة خلايا الجذر"],
      correctAnswer: 4
    },
    {
      question: "جميع العبارات التالية صحيحة ماعدا      ",
      answers: [" الساق موجب الانتحاء الضوئي وسالب الانتحاء الأرضي      ", " الساق سالب الانتحاء الأرضي وموجب الانتحاء المائي      ", "الجذر سالب الانتحاء الضوئي وموجب الانتحاء المائي      ", " الجذر موجب الانتحاء الأرضي وموجب الانتحاء المائي      "],
      correctAnswer: 2
    },
    {
      question: "في كل من الانتحاء الضوئي للجذر والانتحاء الأرضي للجذر في الوضع الأفقى      ",
      answers: [" تعمل الأوكسينات في نفس اتجاه المؤثر       ", " تبتعد الأوكسينات بعيدا عن المؤثر      ", "تعطل الأوكسينات الخلايا عن النمو      ", " تحفز الأوكسينات الخلايا على النمو      "],
      correctAnswer: 3
    },
    {
      question: "في جميع الحالات التالية تقوم الأوكسينات بتشبيط استطالة الخلايا ماعدا في حالة      ",
      answers: [" الانتحاء الضوئي للجذر      ", "  الانتحاء المائي للجذر      ", "الانتحاء الأرضي للساق في الوضع الأفقي      ", " الانتحاء الأرضي للجذر في الوضع الأفقي      "],
      correctAnswer: 3
    },
    {
      question: "أي العبارات التالية تتفق مع طبيعة عمل الأوكسينات ؟",
      answers: [" كلما زاد تركيزها في خلايا الجذر أدى إلى تنشيط استطالتها       ", " كلما قل تركيزها في خلايا الساق أدى إلى تثبيط استطالتها       ", "لا تتأثر بالمؤثرات الخارجية في جميع الأحوال      ", " تنساب من أعلى إلى أسفل في الوضع الأفقي للبادرة      "],
      correctAnswer: 4
    },
    {
      question: "التراكيب الموجودة في نبات المستحية وتشبه عمل المفاصل في الإنسان هي       ",
      answers: [" الوريقات ", "  المحاور الأولية      ", "المحاور الثانوية      ", " الانتفاخات "],
      correctAnswer: 4
    },
